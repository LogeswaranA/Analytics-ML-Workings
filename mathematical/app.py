            ...
            if entity.distance_to(closest_target) < CONVERSION_RADIUS:
                match entity.tribe:
                    ...
                    case "scissors":
                        ...
                        paperClaim -=1
                        rockclaim -=1
                # print("rockclaim:::",rockclaim)
                # print("scissorClaim:::",scissorClaim)
                # print("paperClaim:::",paperClaim)
...
if __name__ == "__main__":
    ...
    User1 = input("Enter your Name ").strip().capitalize()
    user1Input = input("Enter your choice Rock, Paper, or Scissors: ").strip().capitalize()

    User2 = input("Enter your Name ").strip().capitalize()
    user2Input = input("Enter your choice Rock, Paper, or Scissors: ").strip().capitalize()

    User3 = input("Enter your Name ").strip().capitalize()
    user3Input = input("Enter your choice Rock, Paper, or Scissors: ").strip().capitalize()

    if user1Input in ["Rock", "Paper", "Scissors"]:
        winner = gameStart()
        ...
        if winner == user3Input:
            winners.append(User3)
        
        if len(winners) == 3:
            print("You all win!")
        elif len(winners) == 2:
            print(f"{winners[0]} & {winners[1]} wins!")
        elif len(winners) == 1:
