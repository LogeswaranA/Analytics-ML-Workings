...
entities = [Entity(random.randint(0, WINDOW_WIDTH), random.randint(0, WINDOW_HEIGHT), 'rock') for _ in range(100)] + \
           [Entity(random.randint(0, WINDOW_WIDTH), random.randint(0, WINDOW_HEIGHT), 'paper') for _ in range(100)] + \
           [Entity(random.randint(0, WINDOW_WIDTH), random.randint(0, WINDOW_HEIGHT), 'scissors') for _ in range(100)]
...
#                 print("closest_target.tribe",closest_target.tribe)
#                 print("converted",entity.tribe)
...
#     userInput = input("Enter your choice Rock, Paper, or Scissors: ").strip().capitalize()
#     print(userInput)